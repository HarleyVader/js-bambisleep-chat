...
class BrainwaveGenerator {
    constructor() {
        ...
        this.presets = {
            'Deep Sleep': { carrier: 200, beat: 2, description: 'Delta waves for deep sleep' },
            'Light Sleep': { carrier: 220, beat: 6, description: 'Theta waves for drowsiness' },
            'Meditation': { carrier: 250, beat: 10, description: 'Alpha waves for relaxation' },
            'Focus': { carrier: 300, beat: 18, description: 'Beta waves for concentration' },
            'Alert': { carrier: 350, beat: 25, description: 'High beta for peak alertness' },
            'Lucid Dream': { carrier: 200, beat: 7, description: 'Theta for lucid dreaming' },
            'Study': { carrier: 280, beat: 12, description: 'Alpha-beta bridge for learning' }
        };
    ...
    async startBinaural(carrierFreq = 250, beatFreq = 10) {
        ...
        try {
            ...
            this.leftOsc.frequency.setValueAtTime(carrierFreq, this.audioContext.currentTime);
            this.rightOsc.frequency.setValueAtTime(carrierFreq + beatFreq, this.audioContext.currentTime);
            ...
            this.isPlaying = true;
            console.log(`🧠 Binaural beat started: ${carrierFreq}Hz + ${beatFreq}Hz beat`);
            return true;
