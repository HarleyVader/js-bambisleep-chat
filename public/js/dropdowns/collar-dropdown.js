  ...
  getDropdownContent() {
    return `
            <div class="dropdown-header">
                ...
                <p>Configure custom collar parameters</p>
            </div>
            <div class="dropdown-body">
                ...
                <div class="dropdown-section">
                    <div class="dropdown-section-header">Quick Actions</div>
                    <div class="collar-buttons">
                        <button class="collar-btn dropdown-item" data-action="collar-copy" onclick="window.dropdownManager.getComponent('collar').copySettings()">📋 Copy</button>
                        <button class="collar-btn dropdown-item" data-action="collar-paste" onclick="window.dropdownManager.getComponent('collar').pasteSettings()">📄 Paste</button>
                        <button class="collar-btn dropdown-item" data-action="collar-save" onclick="window.dropdownManager.getComponent('collar').saveSettings()">💾 Save</button>
                    </div>
                </div>
                <div class="dropdown-divider"></div>
                <div class="dropdown-section">
                    <div class="dropdown-section-header">Advanced</div>
                    <button class="dropdown-item" data-action="collar-clear" onclick="window.dropdownManager.getComponent('collar').clearSettings(); return false;">🗑️ Clear Settings</button>
                    <button class="dropdown-item" data-action="collar-export" onclick="window.dropdownManager.getComponent('collar').exportSettings(); return false;">📥 Export</button>
                    <button class="dropdown-item" data-action="collar-import" onclick="window.dropdownManager.getComponent('collar').importSettings(); return false;">📤 Import</button>
                </div>
            </div>
        `;
  }
