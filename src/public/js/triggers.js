...
// From src/controllers/trigger.js
  ...
  try {
    ...
    if (!profile.activeTriggerSession) {
      ...
      if (active) {
        ...
        profile.activeTriggerSession.activeTriggers = profile.activeTriggerSession.activeTriggers.filter(t => t !== triggerName);
      }
